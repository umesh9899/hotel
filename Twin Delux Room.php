...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/Twin Delux Room/Twin_img1.jpg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/Twin Delux Room/Twin_img2.jpg"class="thumbnail" alt="im2">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/Twin_img3.jpg"class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/Twin_img4.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/Twin_img5.jpg"class="thumbnail" alt="img5">
    </div>
  </div>
